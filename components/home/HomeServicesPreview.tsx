  ...
  return (
    <section className="relative overflow-hidden bg-brand text-white">
      ...
      <Container className="relative py-12 sm:py-16 lg:py-20">
        ...
        <ul className="mt-8 grid list-none gap-6 sm:grid-cols-2 lg:mt-10 lg:grid-cols-3 lg:gap-8">
        ...
        <RevealOnScroll>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 text-center sm:mt-12 sm:flex-row sm:text-left">
