...
export function PropertyEnergyCertificate({ property }: PropertyEnergyCertificateProps) {
  ...
  return (
    <RevealOnScroll>
      <SectionHeading>Certificado energético</SectionHeading>
      <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/60">
        Eficiencia energética del inmueble según certificación oficial vigente.
      </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
          <div>
            ...
            <div
              ...
              role="img"
              aria-label={`Certificado energético ${cert.rating}. ${ENERGY_RATING_LABELS[cert.rating]}`}
            >
            ...
            <p className="mt-4 font-display text-xl text-white">
              {ENERGY_RATING_LABELS[cert.rating]}
            </p>
          </div>
